...
from giseries_date.functions import recursive_glob
...
setup(
    ...
    license='GPL v2',
    scripts=['giseries_date.py'],
    packages=['giseries_date', 'giseries_date.ui'],
    data_files=[
        ('share/giseries_date/data', ['data/giseries_date.png']),
        ('share/applications', ['data/giseries_date.desktop']),
        ('share/doc/giseries_date', list(chain(glob('doc/*'), glob('*.md')))),
        ('share/giseries_date/ui', glob('ui/*')),
    ],
    cmdclass={
